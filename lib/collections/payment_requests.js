...
PaymentRequest.prototype.isStateReviewed = function() {
  return this.state() === PaymentRequest.States.REVIEWED;
}

PaymentRequest.prototype.isStateReviewed = function() {
  return this.state() === PaymentRequest.States.AUTHORIZING;
}

PaymentRequest.prototype.isStateReviewed = function() {
  return this.state() === PaymentRequest.States.AUTHORIZED;
}

PaymentRequest.prototype.isStateReviewed = function() {
  return this.state() === PaymentRequest.States.PROCESSED;
}
